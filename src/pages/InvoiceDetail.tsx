...
export function InvoiceDetail() {
  ...
  /*
   * This ref points to the actual invoice preview.
   * The PDF is generated from this exact element.
   */
   ...
   * IMPORTANT:
   *
   * The PDF is created from the actual invoice preview.
   *
   * This means:
   *
   * Screen invoice
   ...
   * PDF
   *
   * So the PDF does NOT use a second invoice design.
   */
  ...
  async function createPdf(): Promise<Blob | undefined> {
    ...
    /*
     * Wait one browser frame so images/fonts/layout
     * are fully rendered before capturing.
     */
     ...
     * ==========================================================
     *
     * If the invoice is longer than A4,
     * split the captured invoice across pages.
     *
     * We do NOT rebuild the invoice.
     *
     * We simply split the exact visual invoice.
     */
